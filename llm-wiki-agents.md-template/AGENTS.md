...
- Commit changes only when the user or repository workflow explicitly expects agent-created commits. Before committing, review the diff and verification results.
